...
export const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal  p-10 container mx-auto text-[#64748B] mt-10">
      <aside>
          ...
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                viewBox="0 0 24 24"
                className="w-10 h-10 fill-current bg-[#DB2777] p-2 rounded-full text-white"
              >
      ...
      <nav>
        ...
        <button
          ...
          className="btn bg-[#DB2777] text-white border-none rounded-xl mt-4 py-7 px-7 text-xl"
        >
          Build Your Stack →
        </button>
      </nav>
